...
- [x] ~~**Reautoritzar el token d'Instagram**~~ — fet 2026-09-09: el cron
      de l'1/09 ja l'havia refrescat però només l'imprimia al log; aplicat
      a mà (caduca 2026-10-31) i #487 fa que el cron desi la fila.
