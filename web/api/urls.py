...
urlpatterns = [
    ...
    path(
        "staff/analytics/seo/",
        staff_views.analytics_seo,
        name="staff_analytics_seo",
    ),
    ...
    path(
        "staff/newsletter/esborrany/generar/",
        staff_views.newsletter_esborrany_generar,
    ...
    path(
        "staff/social/metrics-summary/",
        staff_views.social_metrics_summary,
        name="staff_social_metrics_summary",
    ),
    path(
